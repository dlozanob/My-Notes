...
>Si se trabaja con tasas anticipadas, deben convertirse a efectivas, y a partir de ahí convrtirlas a vencidas para poder efectuar los cálculos.
...
\begin{align*}
	...
	&= 4.17ETv\% \\\\
	(1 + 0.0417)^{4} &= (1 + i_{ES})^{2} \\
	i_{ES} &= 8.51\%ESv \\\\
	i_{a} &= \frac{0.0851}{1+0.0851} \\
	&= 7.84\%ESa
\end{align*}
$$
